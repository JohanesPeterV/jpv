...
const navigation = {
  social: [
    {
      name: 'Facebook',
      href: 'https://web.facebook.com/johanes.vincentius/',
      icon: (props) => (
...
export default function ReferenceComponent(props: {
  ...
  return (
    <div
      className={`flex flex-wrap flex-row items-center space-x-6 md:order-2 ${props.className}`}
    >
      {navigation.social.map((item) => (
        <a
          key={item.name}
          href={item.href}
          className='transition-colors duration-300 text-light-text-primary dark:text-dark-text-primary hover:text-light-text-third dark:hover:text-dark-text-third'
        >
