...
export default function IntroComponent() {
    return (
      <div className="transition-position duration-300 flex justify-center flex-col transition-colors duration-300 bg-white dark:bg-dark-primary py-28 sm:py-52">
        <div className="transition-position duration-300 max-w-7xl flex flex-col sm:flex-row sm:space-x-10 md:space-x-12 lg:space-x-16 items-center justify-center mx-auto py-20 px-4 sm:px-6 lg:px-8">
