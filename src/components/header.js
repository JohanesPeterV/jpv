...
export default function HeaderComponent(props) {
  ...
  return (
    <Disclosure
      as="nav"
      className="transition-colors duration-300 bg-light-secondary shadow dark:bg-dark-secondary"
    >
      {({ open }) => (
        <>
            ...
            <div className="relative flex justify-between h-16">
              ...
              <div className="flex-1 flex items-center justify-center sm:items-stretch sm:justify-start">
                <div className="hidden sm:ml-6 sm:flex sm:space-x-8">
                  <Link
                    to='/'
                    className={props.link==='home'?"transition-colors duration-300  border-indigo-400 text-light-text-primary dark:text-dark-text-primary inline-flex items-center px-1 pt-1 border-b-2 text-sm font-medium":"transition-colors duration-300 border-transparent text-light-text-secondary dark:text-dark-text-secondary hover:border-light-text-third hover:text-light-text-primary dark:hover:text-dark-text-primary dark:hover:border-dark-text-third  inline-flex items-center px-1 pt-1 border-b-2 text-sm font-medium"}
                  >
                    Home
                  </Link>
                  ...
                  <Link
                  to='/skills'
                    className={props.link==='skills'?"transition-colors duration-300  border-indigo-400 text-light-text-primary dark:text-dark-text-primary inline-flex items-center px-1 pt-1 border-b-2 text-sm font-medium":"transition-colors duration-300 border-transparent text-light-text-secondary dark:text-dark-text-secondary hover:border-light-text-third hover:text-light-text-primary dark:hover:text-dark-text-primary dark:hover:border-dark-text-third  inline-flex items-center px-1 pt-1 border-b-2 text-sm font-medium"}
                  >
                    Skills
                  </Link>
          ...
          <Disclosure.Panel className="sm:hidden">
            <div className="pt-2 pb-4 space-y-1">
              ...
              <Link
                to="/"
                className={props.link==='home'?'"bg-light-indigo-trans dark:bg-dark-indigo-trans border-indigo-400 text-indigo-400 block pl-3 pr-4 py-2 border-l-4 text-base font-medium"':'transition-colors duration-300 border-transparent text-light-text-secondary dark:text-dark-text-secondary hover:border-light-text-third hover:text-light-text-primary dark:hover:text-dark-text-primary dark:hover:border-dark-text-third  inline-flex items-center px-1 pt-1 border-b-2 text-sm font-medium'}
              >
                Home
              </Link>
              <Link
                to="/skills"
                className={props.link==='skills'?'"bg-light-indigo-trans dark:bg-dark-indigo-trans border-indigo-400 text-indigo-400 block pl-3 pr-4 py-2 border-l-4 text-base font-medium"':'transition-colors duration-300 border-transparent text-light-text-secondary dark:text-dark-text-secondary hover:border-light-text-third hover:text-light-text-primary dark:hover:text-dark-text-primary dark:hover:border-dark-text-third  inline-flex items-center px-1 pt-1 border-b-2 text-sm font-medium'}
              >
